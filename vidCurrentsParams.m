...
params.searchDate = datetime(2017, 10, 01, 16, 00, 00);                       % This date corresponds to the demo data
...
params.vBounds = [-2 0];  % m/s                                                 % if empty, vBounds are defined by the Radon step                                                
